...
//
//                Topic.SubjectType appSubjectType = Topic.SubjectType.PRIVATE;
//                switch (subjectType) {
//                    case "private":
//                        appSubjectType = Topic.SubjectType.PRIVATE;
//                        break;
//                    case "public":
//                        users.addPublicSubject(completeSubject);
//                        appSubjectType = Topic.SubjectType.PUBLIC;
//                        break;
//                    case "connector":
//                        appSubjectType = Topic.SubjectType.CONNECTOR;
//                        break;
//                }
//
//                Topic app = users.getApplication(appId);
