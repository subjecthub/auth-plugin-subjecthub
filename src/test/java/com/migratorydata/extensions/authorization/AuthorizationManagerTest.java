...
public class AuthorizationManagerTest {
    ...
    public void testTwoKeys() throws InterruptedException {
        ...
        key1.put("op", "add_key");
        key1.put("topic", "t-topic1");
        key1.put("key", "t-topic1:xxx:s.p");
        ...
        key2.put("op", "add_key");
        key2.put("topic", "t-topic2");
        key2.put("key", "t-topic2:xxx:s.p");
        ...
        String subject = "/t-topic1";
        ClientCredentials clientCredentials = new ClientCredentials("t-topic2:xxx:s.p", "192.168.1.1:5000");
        SubscribeRequest subscribeRequest = new SubscribeRequest(clientCredentials, subject);
        authorizationManager.handleSubscribeCheck(subscribeRequest);
    ...
    public void testConnectionsLimit() throws InterruptedException {
        ...
        Map<String, Integer> conServer1 = new HashMap<>();
        conServer1.put("t-topic1", 99);
        ...
        Map<String, Integer> conServer2 = new HashMap<>();
        conServer2.put("t-topic1", 2);
    ...
    public void testMessagesLimit() throws InterruptedException {
        ...
        Map<String, Integer> messagesServer1 = new HashMap<>();
        messagesServer1.put("t-topic1", 4999);
